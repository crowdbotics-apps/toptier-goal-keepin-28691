...
## Project Structure
    ...
    ├── toptier_goal_keepin_28691  # Django project configurations
...
1. Clone this repo and `cd toptier_goal_keepin_28691`
...
2. Clone this repo and `cd toptier_goal_keepin_28691`
